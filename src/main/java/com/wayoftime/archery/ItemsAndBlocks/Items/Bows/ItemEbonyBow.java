...
public class ItemEbonyBow extends ItemArchery {
    ...
    {
        super();
        this.setUnlocalizedName("ebony_bow");
    ...
    public void registerIcons(IIconRegister p_94581_1_) {
        this.itemIcon = p_94581_1_.registerIcon("archery:ebony_bow_standby");
        this.iconArray = new IIcon[bowPullIconNameArray.length];

        for (int i = 0; i < this.iconArray.length; ++i) {
            this.iconArray[i] = p_94581_1_.registerIcon("archery:ebony_bow_" + bowPullIconNameArray[i]);
        }
    }
